			...
			<div class="container accueil">
				<div class="row">
					...
					<div class="col-sm-12 col-md-9 col-lg-9">
						...
						$_SESSION['for_follow' . $i] = $donnee['id_follower']; ?>
								...
								<div class="row">
									<div class="profil_following">
										...
										<div class="block_profil_following">
											<div class="follow">
												<button type="button" class="follow_a" id="follow_a<?php echo $i; ?>" value="<?= $_SESSION['for_follow' . $i]; ?>">Follow</button>
											</div>
										</div>
									</div>
								</div>
